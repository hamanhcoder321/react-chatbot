...
export const API_ENDPOINTS = {
  ...
  CHAT_HISTORY: (conversationId) => `${API_BASE_URL}/messages/history/${conversationId}`,
  RECENT_CONVERSATIONS: `${API_BASE_URL}/messages/recent`,
  DELETE_CONVERSATION: (conversationId) => `${API_BASE_URL}/messages/conversation/${conversationId}`,
  SEARCH_MESSAGES: (conversationId) => `${API_BASE_URL}/messages/search/${conversationId}`,
  ...
  ADMIN_SET_PERMISSIONS: (id) => `${API_BASE_URL}/admin/users/${id}/permissions`, // PUT
  ADMIN_ADD_PERMISSION: (id) => `${API_BASE_URL}/admin/users/${id}/permissions`, // POST
  ADMIN_GET_PERMISSIONS: (id) => `${API_BASE_URL}/admin/users/${id}/permissions`, // GET
  ...
  ADMIN_SET_FOLDER_PERMISSIONS: (id) => `${API_BASE_URL}/admin/folders/${id}/permissions`, // PUT
  ADMIN_GET_FOLDER_PERMISSIONS: (id) => `${API_BASE_URL}/admin/folders/${id}/permissions`, // GET
  ...
  // ================= ADMIN - DOCUMENT =================
  ADMIN_DOCUMENTS_LIST: `${API_BASE_URL}/admin/documents`, // GET
